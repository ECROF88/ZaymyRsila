      ...
      <div className="relative z-10 w-full max-w-2xl p-12 bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60">
        <div>
          <div className="flex flex-col items-center">
            <div className="w-60 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg transform hover:rotate-12 transition-transform duration-300">
              <span className="text-3xl text-white font-bold">Code Manager</span>
            </div>
        ...
        <form className="mt-12 space-y-8" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="mt-8 w-full flex justify-center py-4 px-6 border border-transparent text-lg font-medium rounded-xl text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-200 shadow-lg transform hover:scale-[1.02]"
            >
              登录
            </button>
          </div>
